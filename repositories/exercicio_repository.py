...
class ExercicioRepository:
    def listar_todos(self):
        ...
        cursor.execute(
            "SELECT id, nome, grupo_muscular, descricao FROM exercicio ORDER BY nome"
        )
    ...
    def atualizar(self, exercicio):
        ...
        cursor.execute(
            ...
            WHERE id = %s
            """,
            (exercicio.nome, exercicio.grupo_muscular, exercicio.descricao, exercicio.id)
        )
    ...
    def excluir(self, exercicio_id):
        ...
        try:
            # Recomenda-se que o banco tenha ON DELETE CASCADE na tabela exercicio_aparelho
    ...
    def listar_aparelhos_vinculados(self, exercicio_id):
        ...
        cursor.execute(
            """
            SELECT a.id, a.nome, a.descricao, a.status 
            FROM aparelho a
